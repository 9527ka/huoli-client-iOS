...
-(void)requestSuccess:(WH_JXConnection*)task
{
    ...
    @autoreleasepool {
        ...
        }else if([task.action isEqualToString:wh_act_BaiduTranslation]){
...
- (void)WH_wxBaiduTranslation:(NSString *)text language:(NSString *)language toView:(id)toView {
    WH_JXConnection* p = [self addTask:wh_act_BaiduTranslation param:nil toView:toView];
    [p setPostValue:text forKey:@"q"];
    [p setPostValue:@"auto" forKey:@"from"];
    [p setPostValue:language forKey:@"to"];
    ...
    [p setPostValue:[NSString stringWithFormat:@"%d",x] forKey:@"salt"];
    
    NSString *md5Str = [self WH_getMD5StringWithStr:[NSString stringWithFormat:@"%@%@%dfpaFBj3q6DivDokLCXfe",appid,text,x]];
    [p setPostValue:md5Str forKey:@"sign"];
...
//    1: QQ  2: 微信
    ...
    if (type == 1) {//QQ
        ...
        [p setPostValue:openId forKey:@"code"];
    }else if (type == 5) { //facebook
//        [p setPostValue:openId forKey:@"code"];
        [p setPostValue:user.userId forKey:@"userId"];
        [p setPostValue:token forKey:@"otherToken"];
        [p setPostValue:@(type) forKey:@"otherType"];
...
//用户提现
- (void)userWithdrawalWithUserId:(NSString *)userId amount:(NSString *)amount secret:(NSString *)secret context:(NSString *)context accountType:(NSString *)type usdlUrl:(NSString *)usdlUrl toView:(id)toView time:(NSString *)time {
...
//    NSString *secretStr = [[g_server WH_getMD5StringWithStr:@"1234567890"] mutableCopy];
    ...
    [p setPostValue:access_token forKey:@"access_token"];
    [p setPostValue:time forKey:@"time"];
   // [p setPostValue:usdlUrl forKey:@"usdtUrl"];
    [p setPostValue:usdlUrl forKey:@"kkcUrl"];
