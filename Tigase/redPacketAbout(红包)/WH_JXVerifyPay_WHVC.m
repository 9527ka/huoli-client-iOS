...
- (void)WH_setupViews {
    ...
    if (self.type == JXVerifyTypeWithdrawal) {//提现
        ...
        self.serviceChargeTitleLabel.text = Localized(@"New_handling_fee");
        ...
        self.serviceChargeRateTitleLabel.text = Localized(@"New_rate");
...
- (NSString *)WH_getTypeTitle {
    ...
    else if (self.type == JXVerifyTypeSendReadPacket) {
