...
- (id)init
{
    return [self initWithDBName:@"Weqia"];
}
...
- (NSMutableArray *)extractQuery:(NSMutableString *)query where:(NSDictionary*)where
{
...
-(BOOL)updateToDBBase:(NSObject *)model where:(NSDictionary*)where
{
    checkModelIsInvalid(model);
