...
@interface WH_JXCamera_WHVC () <KKImageEditorDelegate,UINavigationControllerDelegate>
...
@implementation WH_JXCamera_WHVC
...
//    [self addPhotoStyle:primaryView];
    ...
    UIButton *cancelImageBtn = [self WH_create_WHButtonWithFrame:CGRectMake(20, JX_SCREEN_HEIGHT-20-80, 80, 80)  image:@"video_return" action:@selector(cancelImageBtnAction:)];
    [_iv addSubview:cancelImageBtn];
    
    UIButton *editBtn = [self WH_create_WHButtonWithFrame:CGRectMake(JX_SCREEN_WIDTH/2-40, JX_SCREEN_HEIGHT-20-80, 80, 80)  image:@"video_edit" action:@selector(editImageBtnAction:)];
    [_iv addSubview:editBtn];
    
    UIButton *confirmBtn = [self WH_create_WHButtonWithFrame:CGRectMake(JX_SCREEN_WIDTH-20-80, JX_SCREEN_HEIGHT-20-80, 80, 80) image:@"video_gou" action:@selector(WH_confirmBtnAction:)];
...
//            break;
//        case 2:
//            showStr = [NSString stringWithFormat:@"%@%ds",Localized(@"WaHu_recordVideo_WHViewController_LessThan"),_minTime];
//            break;
//        default:
//            break;
//    }
...
//    
//    _beautifyFilter = [WH_GPUImageBeautifyFilter alloc];
//
...
- (void) editImageBtnAction:(UIButton *)btn {
    WH_KKImageEditor_WHViewController *editor = [[WH_KKImageEditor_WHViewController alloc] initWithImage:_iv.image delegate:self];
