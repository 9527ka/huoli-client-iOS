...
#import "UIView+WH_ScreenShot.h"
#import "WH_JXUserInfo_WHVC.h"
#ifdef USE_GOOGLEMAP
@interface WH_JXGooMap_WHVC ()<GMSMapViewDelegate,UIScrollViewDelegate>
...
@implementation WH_JXGooMap_WHVC
...
-(void)setOneData:(int)centerIndex{
    ...
    //头像
    [g_server WH_getHeadImageSmallWIthUserId:[NSString stringWithFormat:@"%lld",[dataDict[@"userId"] longLongValue]]
