...
@implementation WH_JXShareList_WHVC
...
//    [topLine release];
    ...
    NSArray *titleArray = @[Localized(@"WeChatFriend"),Localized(@"WeChatMoment")/*,Localized(@"SinaWeibo"),Localized(@"FaceBook"),Localized(@"Twitter"),Localized(@"MiXinatsApp"),Localized(@"SMS"),Localized(@"Line")*/];
...
//        itemImg.backgroundColor = [UIColor magentaColor];
        ...
        itemLabel.font = sysFontWithSize(13);
...
//        itemLabel.backgroundColor = [UIColor purpleColor];
    ...
    cancelBtn.titleLabel.font = sysFontWithSize(16);
