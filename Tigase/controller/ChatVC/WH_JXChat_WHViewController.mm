...
@property (nonatomic, strong) MISFloatingBall *floating;
...
- (void)twoWayWithdrawalMethod {
    ...
    if ([roleData.role intValue] == 1) {
        ...
        [GKMessageTool showText:Localized(@"New_you_are_not_owner_group")];
        return;
    }
}
...
- (void)sendDiamond {
    ...
    WH_JXSendRedPacket_WHViewController * sendDiamondVC = [[WH_JXSendRedPacket_WHViewController alloc] init];
