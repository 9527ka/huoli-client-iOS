...
@interface WH_JXServerList_WHVC () <UITextFieldDelegate>
...
@implementation WH_JXServerList_WHVC
...
//    [self.view addSubview:switchView];
    ...
    UIButton* btn = [UIFactory WH_create_WHButtonWithTitle:Localized(@"JX_Confirm") titleFont:[UIFont systemFontOfSize:15] titleColor:[UIColor blueColor] normal:nil highlight:nil];
