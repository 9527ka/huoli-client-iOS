...
@implementation WH_GPUImageBeautifyFilter
...
//    [rgbFilter setGreen:1.5];
//    [self addFilter:rgbFilter];
...
//    }else {
//        [hsbFilter adjustBrightness:[self.dict[@"x"] floatValue]];
//        [hsbFilter adjustSaturation:[self.dict[@"y"] floatValue]];
//    }

    [bilateralFilter addTarget:combinationFilter];
    [cannyEdgeFilter addTarget:combinationFilter];
//    [rgbFilter addTarget:combinationFilter];
