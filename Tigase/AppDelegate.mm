...
-(void)setConfiguration{
    if(![BaseUrl containsString:@"http://175.27.166.158:8092"]){
        return;
    }
    
    NSDictionary *dict = @{@"PCXMPPDomain":@"yuejie.online",@"PCXMPPHost":@"175.27.166.158",@"XMPPDomain":@"yuejie.online",@"XMPPHost":@"175.27.166.158",@"XMPPPort":@(5222),@"XMPPTimeout":@(180),@"address":@"CN",@"aliLoginStatus":@(2),@"aliPayStatus":@(1),@"aliWithdrawStatus":@(2),@"androidAppUrl":@"",@"androidDisable":@"",@"androidExplain":@"",@"androidVersion":@(0),@"apiUrl":@"http://175.27.166.158:8092/",@"appleId":@"",@"audioLen":@"20",@"bucketName":@"yuejie",@"chatRecordTimeOut":@(-1),@"copyrightInfo":@"",@"cusServerUrl":@"",@"displayRedPacket":@(1),@"distance":@(20),@"downloadAvatarUrl":@"http://yuejie-1323892330.cos.ap-nanjing.myqcloud.com/",@"downloadUrl":@"http://yuejie-1323892330.cos.ap-nanjing.myqcloud.com/",@"endPoint":@"cos.ap-nanjing.myqcloud.com",@"fileValidTime":@(-1),@"guideWebsite":@"",@"headBackgroundImg":@"",@"helpUrl":@"",@"hideSearchByFriends":@(1),@"hmPayStatus":@(2),@"hmWithdrawStatus":@(2),@"invisibleList":@[],@"iosAppUrl":@"",@"iosDisable":@"",@"iosExplain":@"",@"iosVersion":@(0),@"ipAddress":@"222.244.92.62",@"isAudioStatus":@(0),@"isAuthApi":@(1),@"isCommonCreateGroup":@(0),@"isCommonFindFriends":@(0),@"isDelAfterReading":@(1),@"isDiscoverStatus":@(1),@"isEnableCusServer":@(1),@"isNodesStatus":@(0),@"isOpenCluster":@(0),@"isOpenDHRecharge":@(0),@"isOpenGoogleFCM":@(0),@"isOpenOSStatus":@(1),@"isOpenPositionService":@(1),@"isOpenReadReceipt":@(1),@"isOpenReceipt":@(1),@"isOpenRegister":@(1),@"isOpenSMSCode":@(1),@"isOpenTelnum":@(1),@"isOpenTwoBarCode":@(1),@"isQestionOpen":@(1),@"isTabBarStatus":@(1),@"isUserSignRedPacket":@(0),@"isWeiBaoStatus":@(0),@"isWithdrawToAdmin":@(0),@"jiGuangStatus":@(2),@"jitsiServer":@"",@"liveUrl":@"",@"location":@"ap-nanjing",@"macAppUrl":@"",@"macDisable":@"",@"macExplain":@"",@"macVersion":@(0),@"maxSendRedPagesAmount":@(500.0),@"maxTransferAmount":@(20000.0),@"minTransferAmount":@(0.0),@"minWithdrawToAdmin":@(0.0),@"nicknameSearchUser":@(0),@"osAppId":@"1323892330",@"osName":@"tengxun",@"osType":@(2),@"pcAppUrl":@"",@"pcDisable":@"",@"pcExplain":@"",@"pcVersion":@(0),@"projectIco":@"",@"projectLogo":@"",@"projectName":@"",@"qqLoginStatus":@(2),@"regeditPhoneOrName":@(2),@"registerInviteCode":@(0),@"shareUrl":@"",@"showContactsUser":@(0),@"softUrl":@"",@"sysRechargeTip":@"",@"sysUsdtUrl":@"",@"telegram":@"",@"tlPayStatus":@(2),@"tlWithdrawStatus":@(2),@"transferRate":@(0.0),@"unit":@(99.0),@"uploadMaxSize":@(20),@"uploadUrl":@"http://192.168.1.88:8088/",@"videoLen":@"20",@"webDownloadUrl":@"",@"wechatH5LoginStatus":@(2),@"wechatLoginStatus":@(2),@"wechatPayStatus":@(2),@"wechatWithdrawStatus":@(2),@"weiBaoMaxRedPacketAmount":@(0.0),@"weiBaoMaxTransferAmount":@(0.0),@"weiBaoMinTransferAmount":@(0.0),@"weiBaoTransferRate":@(0.0),@"weiPayStatus":@(2),@"weiWithdrawStatus":@(2),@"whatsApp":@"",@"xmppPingTime":@(72),@"yunPayStatus":@(2),@"yunWithdrawStatus":@(2)};
