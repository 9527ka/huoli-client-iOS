...
@interface WH_JXSearchFileLog_WHCell ()
...
@end
@implementation WH_JXSearchFileLog_WHCell
...
- (void)setMsg:(WH_JXMessageObject *)msg {
    ...
    [g_server WH_getHeadImageLargeWithUserId:msg.fromUserId userName:msg.fromUserName imageView:self.headImageView];
    ...
    switch (self.type) {
        ...
        case FileLogType_Link:{
            ...
            if ([msg.type integerValue] == kWCMessageTypeShare) {
                NSDictionary * msgDict = [self.msg.objectId mj_JSONObject];
        ...
        case FileLogType_transact:{
            if ([msg.type integerValue] == kWCMessageTypeRedPacket || [msg.type intValue] == kWCMessageTypeRedPacketExclusive) {
