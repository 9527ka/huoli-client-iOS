...
//    }
    ...
    [pasteboard setString:self.msg.translatedText.length?self.msg.translatedText:self.msg.content];
}
...
//    }else {
    messageConent.text = msg.translatedText.length?msg.translatedText:msg.content;
//    }
