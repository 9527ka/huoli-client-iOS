...
@interface WH_JXSystemImage1_WHCell ()
...
@implementation WH_JXSystemImage1_WHCell
...
//    [self.contentView addSubview:_view];
    ...
    _title.font = sysFontWithSize(15.0);
    ...
    _subtitle.font = sysFontWithSize(14.0);
    ...
    _showAllLabel.font = sysFontWithSize(14.0);
...
-(void)setCellData{
    ...
    id content = [self.msg.content mj_JSONObject];
...
+ (float)getChatCellHeight:(WH_JXMessageObject *)msg {
    ...
    CGSize titleSize = [[content objectForKey:@"title"] boundingRectWithSize:CGSizeMake(kSystemImageCellWidth - 20, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:sysFontWithSize(15)} context:nil].size;
    
    CGSize subtitleSize = [[content objectForKey:@"sub"] boundingRectWithSize:CGSizeMake(kSystemImageCellWidth - 20, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:sysFontWithSize(14)} context:nil].size;
