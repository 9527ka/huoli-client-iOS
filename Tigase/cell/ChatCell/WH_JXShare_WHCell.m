...
@implementation WH_JXShare_WHCell
...
-(void)creatUI{
    ...
    _skIcon.image = [UIImage imageNamed:@"appLogo"];
    ...
    _skLabel.font = sysFontWithSize(14);
...
-(void)setCellData{
    ...
    [_skIcon sd_setImageWithURL:[NSURL URLWithString:[msgDict objectForKey:@"appIcon"]] placeholderImage:[UIImage imageNamed:@"appLogo"]];
