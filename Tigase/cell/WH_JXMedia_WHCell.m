...
@implementation WH_JXMedia_WHCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self){
        ...
        UIFont* f0 = sysFontWithSize(15);
//        UIFont* f1 = sysBoldFontWithSize(15);
...
//        [iv release];
        ...
        _player= [[WH_JXVideoPlayer alloc] initWithParent:iv];
