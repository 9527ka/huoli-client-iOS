...
@interface WH_JXCourseList_WHCell()
...
@implementation WH_JXCourseList_WHCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self){
        ...
        _timeLabel.font = sysFontWithSize(15);
        ...
        _multiselectBtn.titleLabel.font = pingFangRegularFontWithSize(10);
