...
@interface WH_RechargeSelectAccount_WHCell ()<UITextFieldDelegate>
...
//    [self.usdtTextField mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.contentView).mas_offset(20);
//        make.right.mas_offset(-20);
//        make.top.mas_equalTo(wh_lineView.mas_bottom).mas_offset(0);
//        make.height.mas_equalTo(54);
//    }];
}
