...
- (instancetype)init {
    return [self initWithFrame:CGRectMake(0, 0, JX_SCREEN_WIDTH, 50)];
}
                    ...
                    if(lastRow >= 0) {
                        if(tableView.visibleCells.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                self.frame = CGRectMake(0, CGRectGetMaxY(tableView.visibleCells.lastObject.frame), JX_SCREEN_WIDTH, 50);
                            }
                        }
                    }
                }
                    ...
                    if(lastRow >= 0) {
                        if(collectionView.indexPathsForVisibleItems.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                ...
                                self.frame = CGRectMake(0, CGRectGetMaxY(cell.frame), JX_SCREEN_WIDTH, 50);
                            }
                        }
                    }
                }
...
- (void)layoutSubviews {
    ...
    if (!_superView) {
        ...
        edgeInsets.bottom += (50 + JX_SCREEN_BOTTOM);
...
- (void)updateFrame {
    if([self.superView isKindOfClass:[UITableView class]]) {
        ...
        self.frame = CGRectMake(0, y, JX_SCREEN_WIDTH, 50);
    }
