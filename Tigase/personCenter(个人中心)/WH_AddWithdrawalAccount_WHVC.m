...
- (void)loadContent {
    ...
    if (self.withdrawAccountType == WithdrawAccountTypeAlipay) {
        ...
        self.wh_placeholderArray = @[@"名字", Localized(@"New_account_number")];
    } else {
...
- (void)WH_bindWithdrawalAccountAction {
    ...
    if (textFieldArray.count == 0) {
        [g_App showAlert:Localized(@"New_please_fill_information")];
        return;
    }
    NSDictionary *param = @{};
    if (self.withdrawAccountType == WithdrawAccountTypeBankCard) {
        ...
        if (textField0.text.length == 0) {
            [g_App showAlert:Localized(@"New_please_enter_your_name")];
            return;
        }
        if (textField1.text.length == 0) {
            [g_App showAlert:Localized(@"New_please_enter_bank_card_number")];
            return;
        }
        if (textField2.text.length == 0) {
            [g_App showAlert:Localized(@"New_please_enter_bank_name")];
            return;
        }
        ...
        if (textField1.text.length == 0) {
            [g_App showAlert:Localized(@"New_please_enter_account_number")];
            return;
        }
