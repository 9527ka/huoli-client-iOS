...
@interface WH_JXConstant : NSObject{
    FMDatabase* _db;
    NSString *_sysName;
...
@property (nonatomic ,strong) NSMutableDictionary *chatBackgrounImage; //聊天背景
...
@property (nonatomic ,strong) NSNumber *isAddFriend; //当前用户是否允许添加好友
