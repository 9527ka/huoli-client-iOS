...
- (void)layoutSubviews {
    ...
    [_headImageView headRadiusWithAngle:_headImageView.frame.size.height * 0.5];
    ...
    [_bgImageView headRadiusWithAngle:self.frame.size.height * 0.5];
...
- (void)setModel:(GiftModel *)model {
    ...
    _giftLabel.text = [NSString stringWithFormat:@"%@%@",Localized(@"JXLiveVC_Give"),model.giftName];
