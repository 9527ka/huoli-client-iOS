...
@implementation WH_JXRoomRemind
@synthesize userId,objectId,time,type,roomId,fromUserName;

static WH_JXRoomRemind *shared;
...
-(void)notify{
    //发送全局通知
    [g_notify postNotificationName:kXMPPRoom_WHNotifaction object:self userInfo:nil];
}
...
/*
 ...
 //        shared=[[WH_JXRoomRemind alloc] init];
 //    });
 //    return shared;
 //}
