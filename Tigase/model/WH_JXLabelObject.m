...
@implementation WH_JXLabelObject


static WH_JXLabelObject *sharedLabel;

+(WH_JXLabelObject*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedLabel=[[WH_JXLabelObject alloc]init];
    });
    return sharedLabel;
}
...
-(NSMutableArray*)fetchAllLabelsFromLocal {
    ...
    for (WH_JXLabelObject *jxLabelObject  in resultArr) {
        
        if([jxLabelObject.groupName isEqualToString:@"家人"] ||
           [jxLabelObject.groupName isEqualToString:Localized(@"New_family")]){
            jxLabelObject.groupName = Localized(@"New_family");
        }
        
        if([jxLabelObject.groupName isEqualToString:@"同事"] ||
           [jxLabelObject.groupName isEqualToString:Localized(@"New_colleague")]){
            jxLabelObject.groupName = Localized(@"New_colleague");
        }
...
-(void)labelFromDataset:(WH_JXLabelObject*)obj rs:(FMResultSet*)rs{
