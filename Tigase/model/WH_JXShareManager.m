...
@implementation WH_JXShareManager

static WH_JXShareManager *shared;

+ (WH_JXShareManager *)defaultManager{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared = [[WH_JXShareManager alloc] init];
    });
    return shared;
}
...
//            break;
        case JXShareToWechatSesion:     //微信
        {
            ...
            [self shareWebPageToPlatformType:UMSocialPlatformType_WechatSession url:shareModel.shareUrl title:shareModel.shareTitle content:shareModel.shareContent image:shareModel.shareImage];
...
//            }];
        ...
        {
            [self shareWebPageToPlatformType:UMSocialPlatformType_WechatTimeLine url:shareModel.shareUrl title:shareModel.shareTitle content:shareModel.shareContent image:shareModel.shareImage];
        }
            break;
...
- (void)shareWebPageToPlatformType:(UMSocialPlatformType)platformType url:(NSString *)url title:(NSString *)title content:(NSString *)content image:(id)image
{
    //创建分享消息对象
