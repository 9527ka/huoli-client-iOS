...
@implementation WH_SCGIFImageView
...
+ (NSMutableArray*)getGifFrames:(NSData*)gifImageData {
	WH_SCGIFImageView* gifImageView = [[WH_SCGIFImageView alloc] initWithGIFData:gifImageData];
	if (!gifImageView) {
		return nil;
	}
...
- (id)initWithGIFData:(NSData*)gifImageData {
	...
	if (![WH_SCGIFImageView isGifImage:gifImageData]) {
