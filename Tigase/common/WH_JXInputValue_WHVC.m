...
- (id)init
{
    ...
    if (self) {
        ...
        self.title = Localized(@"New_group_announcement");
...
- (void)createContentView {
    ...
    [self.textDefaultLabel setText:Localized(@"New_please_enther_group_announcement")];
...
//            [g_App showAlert:Localized(@"JX_NameCanNot")];
            [g_App showAlert:Localized(@"New_group_description_cannot_empty")];
