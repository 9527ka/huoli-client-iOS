...
- (void)viewDidLoad{
    ...
    self.title = Localized(@"JX_Receiving");
...
//    [_baseView addSubview:payLabel];
    ...
    [label setText:Localized(@"New_scan_pay_me")];
    ...
    [yLabel setText:Localized(@"New_receipt_directly_account")];
...
//    [_leftLabel addSubview:botLine];
    ...
    [mLabel setText:Localized(@"New_scan_to_pay")];
