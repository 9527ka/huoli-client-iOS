...
static CGFloat imageWH = 200;
static CGFloat paddingScale = 2;
@implementation UIImage (WH_Addtions)
...
+ (UIImage *)groupIconWith:(NSArray *)array bgColor:(UIColor *)bgColor {
    ...
    CGSize finalSize = CGSizeMake(imageWH, imageWH);
    ...
    if (bgColor) {
        ...
        CGContextAddLineToPoint(context, 0, imageWH);
        CGContextAddLineToPoint(context, imageWH, imageWH);
        CGContextAddLineToPoint(context, imageWH, 0);
...
+ (NSArray *)eachRectInGroupWithCount:(NSInteger)count {
    ...
    CGFloat sizeValue = imageWH;
    CGFloat padding = 8 * paddingScale;
...
+ (NSArray *)eachRectInGroupWithCount2:(NSInteger)count {
    ...
    CGFloat sizeValue = imageWH;
    CGFloat padding = 10 * paddingScale;
