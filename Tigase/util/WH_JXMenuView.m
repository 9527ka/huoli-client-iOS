...
#define TEXT_FONT   sysFontWithSize(14) // 字体大小

@interface WH_JXMenuView ()
...
- (void)WH_setupViews {
    ...
    NSInteger w = 0;
    UIButton *cellView;
    for (int i = 0; i < self.wh_titles.count; i++) {
        NSString *str = self.wh_titles[i];
