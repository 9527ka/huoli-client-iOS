...
@interface WH_JXMoreSelect_WHVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation WH_JXMoreSelect_WHVC
...
//    [self.baseView addGestureRecognizer:tap];
    ...
    self.indexArr = [NSMutableArray arrayWithArray:[self.wh_indexStr componentsSeparatedByString:@","]];
