...
#import "WH_KKMosaicTool.h"
#import "WH_KKMosaicView.h"

@implementation WH_KKMosaicTool{

    WH_KKMosaicView *mosaicView; //显示马赛克
...
- (void)setup{
    ...
    mosaicView = [[WH_KKMosaicView alloc]initWithFrame:self.editor.imageView.bounds];
