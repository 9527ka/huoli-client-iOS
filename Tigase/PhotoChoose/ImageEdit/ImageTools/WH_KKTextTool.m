...
@interface WH_KKTextTool()<UITextViewDelegate>
...
{
    [WH_KKTextView setActiveTextView:nil];
...
- (void)textSaveBtn{
    ...
    if (self.selectedTextView) {
        ...
        WH_KKTextView *view = [[WH_KKTextView alloc] initWithTool:self];
        ...
        [WH_KKTextView setActiveTextView:view];
    }
