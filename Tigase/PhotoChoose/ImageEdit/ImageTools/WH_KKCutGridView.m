...
#import "WH_KKCutCircle.h"
#import "WH_KKCutGridLayer.h"
...
@implementation WH_KKCutGridView{
    WH_KKCutGridLayer *_gridLayer;
    
    //4个角
    WH_KKCutCircle *_ltView;
    WH_KKCutCircle *_lbView;
    WH_KKCutCircle *_rtView;
    WH_KKCutCircle *_rbView;
}
...
- (id)initWithSuperview:(UIView*)superview frame:(CGRect)frame{
    ...
    if(self){
        ...
        _gridLayer = [[WH_KKCutGridLayer alloc] init];
...
//4个角的拖动圆球
- (WH_KKCutCircle*)clippingCircleWithTag:(NSInteger)tag
{
    WH_KKCutCircle *view = [[WH_KKCutCircle alloc] initWithFrame:CGRectMake(0, 0, 75, 75)];
    view.tag = tag;
