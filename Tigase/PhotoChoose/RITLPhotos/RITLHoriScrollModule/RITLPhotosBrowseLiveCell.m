...
- (void)liveWH_PhotoView:(PHLivePhotoView *)liveWH_PhotoView willBeginPlaybackWithStyle:(PHLivePhotoViewPlaybackStyle)playbackStyle
{
    self.isPlaying = true;
    self.livePhotoView.hidden = false;
}

- (void)liveWH_PhotoView:(PHLivePhotoView *)liveWH_PhotoView didEndPlaybackWithStyle:(PHLivePhotoViewPlaybackStyle)playbackStyle
{
    self.isPlaying = false;
