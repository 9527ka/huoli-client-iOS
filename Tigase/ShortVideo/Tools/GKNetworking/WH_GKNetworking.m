...
@implementation WH_GKNetworking
...
+ (void)requestWithType:(WH_GKNetworkingType)type url:(NSString *)url params:(NSDictionary *)params success:(void(^)(id responseObject))success failure:(void (^)(NSError *error))failure {
